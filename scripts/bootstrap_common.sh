...
# Install utilities
echo "[TASK] Install utilities"
yum install -y -q yum-utils device-mapper-persistent-data lvm2 vim git nfs-utils >/dev/null 2>&1
...
echo "[TASK] Stop and Disable firewalld"
